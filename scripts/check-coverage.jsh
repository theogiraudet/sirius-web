...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-view-tree-edit", 15.0),
  new ModuleCoverage("sirius-components-view-emf", 81.0),
  ...
  new ModuleCoverage("sirius-components-view-diagram-customnodes-edit", 79.0),
