...
- https://github.com/eclipse-sirius/sirius-web/issues/6157[#6157] [diagram] Every diagram that not declare a toolbar will not have a toolbar anymore.
A toolbar will be added by a migration participant for existing runtime diagram definition.


=== Dependency update

- [releng] Switch to https://github.com/spring-projects/spring-boot/releases/tag/v3.5.10[Spring Boot 3.5.10]
